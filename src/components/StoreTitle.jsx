        ...
        <div className='storeTitle'>
            ...
            <div className="infoList">
                <div className="info1 info">
                    <div className="avata"><img src={process.env.PUBLIC_URL + 'img/store-chat-specialist-icon-202309_AV2.jpg'} alt="avata" /></div>
                    <div className="infoText">
                        <p>쇼핑 지원이 필요하다면?</p>
                        <p className="infoTextblue">스페셜리스트에게 문의하세요</p>
                    </div>
                </div>
                <div className="info2 info">
                    ...
                    <div className="infoText">
                        ...
                        <p className="infoTextblue">가까운 매장 찾기</p>
                    </div>
                </div>
            </div>
        </div>
